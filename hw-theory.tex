...
$$\infer[\text{Case}]{\Gamma\vdash Case\ L\ R\ D : \gamma}{\Gamma\vdash L : \alpha\rightarrow\gamma\quad\Gamma\vdash R: \beta\rightarrow\gamma\quad D:\Gamma\vdash\alpha\vee\beta}$$
...
\item Покажите, что они не имеют типа в просто-типизированном лямбда-исчислении.
\item Выразите их в языке Хаскель (Окамль). Каков его тип?
\end{enumerate}
